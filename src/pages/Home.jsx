...
function Home() {
  ...
  return (
    <div>
      <Header></Header>
      <main className="hero mt-2 flex flex-col items-center justify-between gap-5 bg-white md:flex-row">
        <div className="flex w-full flex-col content-between p-10 md:w-1/2">
          <div>
            ...
            <button className="mt-6 rounded-md bg-[#FB8E0B] px-4 py-3 text-white shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2">
              Start Chatting Now
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="ml-2 inline h-6 w-6 font-semibold">
              ...
              <svg className="size-20 sm:size-24 md:size-28 lg:size-32" width={135} height={69} viewBox="0 0 135 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  ...
                  <clipPath id="clip1_2_1260">
                    <rect width="77.0099" height="12.46" fill="white" transform="translate(0 51)" />
                  </clipPath>
                </defs>
              </svg>
            </div>
      ...
      <main className="features">
        ...
        <div className="flex w-full flex-col items-center gap-10 pb-20 md:flex-row md:justify-center md:gap-10 md:px-20">
          {/* camera */}
        ...
        <div className="flex w-full flex-col bg-[#F8F8FA] py-8 md:flex-row md:gap-10 md:px-10">
          {/* Image Section */}
          <img className="mx-auto w-4/5 max-w-sm md:w-1/2 md:max-w-md" src="../assets/woman-with-video-call.png" alt />
          {/* Text Section */}
        ...
        <div className="flex w-full flex-col py-8 md:flex-row-reverse md:gap-10 md:px-10">
          {/* Image Section */}
          <img className="mx-auto w-4/5 max-w-sm md:w-1/2 md:max-w-md" src="../assets/chat-demo.png" alt />
          {/* Text Section */}
          <div className="flex w-full flex-col items-center gap-5 md:w-1/2 md:items-start">
            <p className="px-8 py-5 text-center text-xl font-semibold md:text-left md:text-2xl">
      ...
      <main className="bg-[#FB8E0B] py-10">
